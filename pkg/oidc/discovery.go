...
func WriteDiscovery(w io.Writer, s3BucketName string) error {
	...
	v := DiscoveryResponse{
		Issuer:                           fmt.Sprintf("https://%s.s3.amazonaws.com", s3BucketName),
		JwksURI:                          fmt.Sprintf("https://%s.s3.amazonaws.com/jwks.json", s3BucketName),
